...
instead of resolving. Ruling makes that contract explicit and closes it.
...
A card that can't be stated this way isn't ready for ruling — reconcile
...
4. Bring a recommendation, not a menu, per standing orders — your pick and
   ...
   Solace's answer.
5. Apply the output per the contract above, immediately — don't batch.
6. Next card, or stop when Solace says stop. Unfinished cards keep their
